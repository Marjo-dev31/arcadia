const QUERYHABITATS = {
    SELECT_HABITATS:'SELECT title, description, comment, habitats.id, images.image_url, images.id AS image_id FROM habitats LEFT JOIN images ON habitats.id = images.id_habitat',
